...
document.getElementById("btn").addEventListener("click",function(){
    document.getElementById("weixin_share").setAttribute("data-bshare",'{type:"weixin",url:"http://www.baidu.com",pop:"true",title:"百度",desc:"分享百度",summary:"一个很牛逼的网站",images:"https://imgs.wbp5.com/api/secrecymaster/html_up/2020/3/20200327115851614.png"}')
