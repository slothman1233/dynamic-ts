...
class SPSParser {
    ...
    static _ebsp2rbsp(uint8array:any) {
    ...
    static _skipScalingList(gb:any, count:any) {
        let last_scale = 8,
            next_scale = 8;
        let delta_scale = 0;
    ...
    static getProfileString(profile_idc:any) {
        switch (profile_idc) {
            case 66:
                return 'Baseline';
            case 77:
    ...
    static getLevelString(level_idc:any) {
        return (level_idc / 10).toFixed(1);
    }

    static getChromaFormatString(chroma:any) {
        switch (chroma) {
            case 420:
                return '4:2:0';
            case 422:
